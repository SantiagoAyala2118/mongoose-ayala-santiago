...
La solución que encontré para esto fue hacer un endpoint en el que, por parámetros reciba un id de un usuario, y por el body reciba un nombe de algún grupo, de esta forma estoy básicamente ***agregando usuarios a grupos*** y generando el vínculo, como se ve a continuación:
```javascript
...
```
 #### ***Con esto quedaría finalizada la explicación de los puntos claves solicitados por los profesores, muchas gracias.***
